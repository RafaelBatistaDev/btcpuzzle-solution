...
# ///
"""
BNB Address Checker com Relatório Final
...
def is_line_with_balance(line: str) -> bool:
    ...
    try:
        ...
        final_bnb = data.get('finalBalanceBnb', '0.000000000000000000')
        n_tx = data.get('nTx', 0)
        if balance_str != '0' or final_balance != 0 or final_bnb != '0.000000000000000000' or n_tx != 0:
            return True
    except:
        pass
    return False
...
def main():
    ...
    # Pastas a verificar
    puzzle_folders = [
        script_dir / "bnb" / "PUZZLE_71",
        script_dir / "bnb" / "PUZZLE_72",
        script_dir / "bnb" / "PUZZLE_73",
    ]
    ...
    # Arquivo de saída
    output_file = relatorio_dir / "bnb_addresses_with_balance.jsonl"
