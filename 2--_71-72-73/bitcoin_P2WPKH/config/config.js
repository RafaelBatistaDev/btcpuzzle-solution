...
export const PUZZLE_CONFIG = {
  71: {
    name: 'BTC_PUZZLE_71',
    target: envConfig.BTC_P2WPKH_TARGET_71 || process.env.BTC_P2WPKH_TARGET_71 || 'bc1q...',
    // 2^70 .. 2^71-1
  ...
  72: {
    name: 'BTC_PUZZLE_72',
    target: envConfig.BTC_P2WPKH_TARGET_72 || process.env.BTC_P2WPKH_TARGET_72 || 'bc1q...',
    // 2^71 .. 2^72-1
  ...
  73: {
    name: 'BTC_PUZZLE_73',
    target: envConfig.BTC_P2WPKH_TARGET_73 || process.env.BTC_P2WPKH_TARGET_73 || 'bc1q...',
...
export const RUNTIME_CONFIG = {
  ...
  BATCH_SIZE: Number(
    process.env.BTC_P2WPKH_BATCH_SIZE || envConfig.BTC_P2WPKH_BATCH_SIZE ||
    process.env.BTC_BATCH_SIZE        || envConfig.BTC_BATCH_SIZE        ||
    process.env.BATCH_SIZE            || envConfig.BATCH_SIZE            ||
    20
  ),
  DELAY_MS: Number(
    process.env.BTC_P2WPKH_DELAY_MS     || envConfig.BTC_P2WPKH_DELAY_MS     ||
