...
/**
 * PROJETO: LITECOIN P2SH-P2WPKH (BIP49) - Puzzle Solver
 */

import { LitecoinSolver } from './config/solver.js';
import { RUNTIME_CONFIG } from './config/config.js';

console.log('\n╔════════════════════════════════════════════════════════════╗');
console.log('║  🚀 LITECOIN P2SH PUZZLE SOLVER - Iniciando                ║');
console.log('╚════════════════════════════════════════════════════════════╝\n');
...
const solver = new LitecoinSolver(puzzleId);
