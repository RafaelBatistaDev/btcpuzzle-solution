...
/**
 * Dogecoin P2SH Batch History Checker
...
function checkDogecoinBatchHistory() {
  ...
  const reportFile  = path.join(reportsDir, `dogecoin_p2sh_report_${timestamp}.txt`);

  const allResults  = {};
  const reportLines = [];

  reportLines.push('='.repeat(80));
  reportLines.push('DOGECOIN P2SH BATCH HISTORY REPORT');
  ...
  console.log(`\n📄 Relatório salvo: reports/dogecoin_p2sh_report_${timestamp}.txt`);
